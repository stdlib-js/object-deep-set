...
var A=require('@stdlib/assert-is-object-like/dist'),K=require('@stdlib/assert-is-string/dist').isPrimitive,B=require('@stdlib/assert-is-array/dist'),F=require('@stdlib/error-tools-fmtprodmsg/dist'),R=l(),z=c(),C=q();function D(e,r,n,u){var a,s,i,t;if(!A(e))return!1;if(a=K(r),!a&&!B(r))throw new TypeError(F('2pJ3A',r));if(i=z(),arguments.length>3&&(t=R(i,u),t))throw t;return a?s=r.split(i.sep):s=r,C(e,s,i.create,n)}g.exports=D
});var O=f(function(er,w){
var G=require('@stdlib/assert-is-string/dist').isPrimitive,H=require('@stdlib/assert-is-array/dist'),I=require('@stdlib/assert-is-object-like/dist'),J=require('@stdlib/error-tools-fmtprodmsg/dist'),M=l(),N=c(),Q=q();function U(e,r){var n,u,a,s;if(n=G(e),!n&&!H(e))throw new TypeError(J('2pJ3A',e));if(a=N(),arguments.length>1&&(s=M(a,r),s))throw s;return n?u=e.split(a.sep):u=e,i;function i(t,v){return I(t)?Q(t,u,a.create,v):!1}}w.exports=U
